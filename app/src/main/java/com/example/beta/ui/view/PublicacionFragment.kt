...
class PublicacionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.breedsLiveData.observe(viewLifecycleOwner) { breeds ->
            // Update the adapter with the retrieved list of breeds
            breedsAdapter.clear()
            breedsAdapter.addAll(breeds.map { it.breedName }) // Assuming BreedEntity has a breedName property
